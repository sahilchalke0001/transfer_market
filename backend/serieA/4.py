...
# ✅ Load & preprocess Serie A data
# Ensure your CSV has columns: HomeTeam, AwayTeam, FTHG, FTAG
matches = pd.read_csv(r"C:\Users\Sahil\Desktop\s\backend\SerieA\SerieAdata.csv")
...
# 🚀 API route
@app.route("/seriea_predict", methods=["POST"])
def predict():
